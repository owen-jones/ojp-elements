...
| `showSocialIcons`       | `show-social-icons`     | Show social media icons in the footer or not | `boolean`                                                       | `false`                             |
| `socialIconsList`       | --                      | Social media icons list                      | `{ icon: string; link: string; }[]`                             | `[]`                                |
...
| Name                               | Description                                  |
| ---------------------------------- | -------------------------------------------- |
| `--ojp-footer--example-public-var` | Description of this variable. Defaults to X. |
